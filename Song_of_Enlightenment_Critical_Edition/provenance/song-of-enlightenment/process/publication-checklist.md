...
- [x] package-local OCR runner created

- [x] package-local tranche launcher created

- [x] PaddleOCR word-box OCR startup configured

- [x] OCR tranche 1 image baseline completed
