...
| `YJG-C3` | `lead` | `commentary / response witness` | `late transmission` | `證道歌頌` | not yet acquired into this package | `https://tripitaka.cbeta.org/ko/X65n1291_001?order=title&sort=asc` | CBETA commentary / response branch, secondary control |
