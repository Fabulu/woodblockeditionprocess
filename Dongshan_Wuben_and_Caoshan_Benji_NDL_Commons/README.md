# Dongshan Wuben and Caoshan Benji / NDL Commons
...
- Status: two-part set downloaded and validated with PyMuPDF (`100`, `100` pages).
- Notes: compilation/translation witness from `国訳禅宗叢書 第8巻`, whose contents explicitly include `洞山悟本大師語録` and `撫州曹山本寂禅師語録`.
