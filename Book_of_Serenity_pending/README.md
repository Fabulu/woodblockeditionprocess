# Book of Serenity / pending free-text witness

- Work: `萬松老人評唱天童覺和尚頌古從容庵錄`
- Priority: high
...
- Completeness: root structure appears complete with `卷001` through `卷006`, but the local free-text package has not been captured and vetted yet.
- Local files:
  - `README.md`
- Status: pending, not acquired as a free-text witness.
- Notes: `T48n2004` is already acquired in this repo from a validated scan witness. This folder tracks only the unresolved Wikisource free-text lead.
