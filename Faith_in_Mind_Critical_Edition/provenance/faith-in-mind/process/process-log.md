...
| 2026-04-15 | OCR support extension | Derived Paddle column-ordered support text for the active early-prose slice from saved JSON geometry | `T1-p005` to `T1-p010` now also have a geometry-sorted support view under `ocr/T1/ocr/paddleocr-ppocrv4/column-ordered-text/` to reduce reading-order noise on vertical pages |
