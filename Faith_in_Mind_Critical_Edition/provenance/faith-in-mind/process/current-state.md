...
- the current in-package evidence basis remains exhausted at `T1-p033.l03`, `T1-p033.l05`, and `T1-p034.l05`, but the second-pass queue is not paused there because the remaining `T1-p030` residue (`l03`, `l08`), the older `T1-p029` residue (`l02`, `l06`), and the earlier single-locus holdouts at `T1-p011.l04`, `T1-p012.l02`, and `T1-p014.l08` still offer bounded productive slices.
