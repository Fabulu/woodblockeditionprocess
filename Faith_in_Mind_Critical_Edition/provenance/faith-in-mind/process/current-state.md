...
- `T1-p036.l02`, `T1-p036.l03`, `T1-p036.l04`, `T1-p036.l06`, `T1-p036.l07`, and `T1-p036.l09` are now also secured from direct image review plus convergent local OCR support and bounded comparison corroboration where needed.
- the main live holdouts immediately around this point are `T1-p032.l05`; the still-open `T1-p033.l03`, `l04`, `l05`, `l06`, `l07`, and `l09` columns; the remaining `T1-p034.l02`, `l03`, `l05`, and `l06` residue; the surviving short-fragment problem at `T1-p035.l09`; and the remaining `T1-p036` residue around `l05` and the left-of-center `大地甚處得來...` prose.
- the next required bounded slice is to continue image-led manual correction on the remaining `T1-p036` residue, especially the ambiguous `l05` versus `大地甚處得來...` mapping problem, before considering a move beyond the page.
