...
- the current in-package evidence basis remains exhausted at those three loci, but the second-pass queue is not paused there because `T1-p031.l03`, the remaining `T1-p030` residue, and the older `T1-p029` residue continue to offer bounded productive slices.
