...
- Last completed phase: `manual_correction_slice_lemma_spine_through_T1_p079_l01`
...
- Paddle column-ordered support text now exists for `T1-p005` to `T1-p010` to reduce vertical reading-order noise

## Next action

Continue Stage 2D manual correction against the corrected working spine, starting with OCR-supported prefatory and early commentary prose on `T1-p005` to `T1-p010`.
...
- the raw extracted Paddle text can also have unstable ordering on vertical pages; use `ocr/T1/ocr/paddleocr-ppocrv4/column-ordered-text/` as an additional support view on `T1-p005` to `T1-p010`
