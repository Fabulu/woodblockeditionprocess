...
- a later package-state sync has now also retired stale `unresolved-loci.md` notes that still listed old `T1-p032` residue as open; this does not change the exhausted 12-locus visual-workbench queue, which remains `T1-p007.l03`, `T1-p007.l04`, `T1-p007.l08`, `T1-p007.l09`, `T1-p007.l12`, `T1-p012.l02`, `T1-p029.l02`, `T1-p029.l06`, `T1-p030.l08`, `T1-p033.l03`, `T1-p033.l05`, and `T1-p034.l05`.
