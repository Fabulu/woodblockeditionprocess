...
- the next required bounded slice is to leave the now-exhausted `T1-p036` page behind and resume the earliest unresolved second-pass holdout, starting with `T1-p032.l05` and then the `T1-p033` residue.
