...
PAGE_DIR = Path(r"C:\woodblocks\Faith_in_Mind_Critical_Edition\provenance\faith-in-mind\ocr\C10\page-images")
OUT_DIR = BASE_DIR
...
def main() -> None:
    ...
    seen = {
        entry["page"]
        for entry in summary.get("page_results", [])
    ...
    pages = sorted(PAGE_DIR.glob("C10-p*.png"))
    for page in pages:
        page_id = page.stem
