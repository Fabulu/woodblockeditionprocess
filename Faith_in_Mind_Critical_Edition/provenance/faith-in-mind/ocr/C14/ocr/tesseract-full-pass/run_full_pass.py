...
PAGE_DIR = Path(r"C:\woodblocks\Faith_in_Mind_Critical_Edition\provenance\faith-in-mind\ocr\C14\ocr-input-120dpi")
...
def main() -> None:
    ...
    pages = sorted(PAGE_DIR.glob("C14-p*.jpg"))
    if RUN_SUMMARY.exists():
        ...
        summary = {
            ...
            "input_basis": "120dpi JPEG derivatives from C14/page-images; used because direct 150dpi PNG Tesseract run completed only C14-p001 before a 10-minute timeout",
