...
def main() -> None:
    ...
    if RUN_SUMMARY.exists():
        ...
        summary = {"engine": "Tesseract", "witness_id": "C17", "input_dir": str(PAGE_DIR), "input_basis": "120dpi JPEG derivatives from C17/page-images; used for C17 OCR to keep the long 218-page witness computationally manageable on this workstation", "tesseract_exe": str(TESSERACT_EXE), "lang": "chi_tra", "psm": 6, "tessdata_prefix": str(TESSDATA_PREFIX), "pages_total": len(pages), "pages_with_text": 0, "pages_without_text": [], "errors": [], "warnings": [], "pages": [], "resumed": False}
