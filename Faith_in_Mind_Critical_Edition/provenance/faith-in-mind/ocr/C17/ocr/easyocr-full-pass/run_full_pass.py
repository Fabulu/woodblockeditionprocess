...
PAGE_DIR = Path(r"C:\woodblocks\Faith_in_Mind_Critical_Edition\provenance\faith-in-mind\ocr\C17\ocr-input-90dpi")
...
def main() -> None:
    ...
    if RUN_SUMMARY.exists():
        ...
        summary = {"engine": "easyocr", "scope": "full-pass", "languages": ["ch_tra", "en"], "gpu": False, "input_dir": str(PAGE_DIR), "resumed": False, "total_pages": len(pages), "pages_with_text": 0, "no_text_pages": [], "error_count": 0, "errors": [], "output_dir": str(OUT_DIR), "elapsed_seconds": 0}
    for page in pages:
        page_id = page.stem
        ...
        try:
            ...
            json_path.write_text(json.dumps({"page_id": page_id, "source_image": page.name, "results": normalized}, ensure_ascii=False, indent=2), encoding="utf-8")
